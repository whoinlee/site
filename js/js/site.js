...
;(function($) {
    $(document).ready(function(){
        ...
        */
        console.log("INFO site.js.js :: document.ready!!!");
    });
})(jQuery);
...
Site.toggleOverlay = function(number) {
    ...
    console.log("INFO site.js.js :: Site.toggleOverlay called, number is " + number);
    //
    var overlay = $("#overlay");
...
Site.openInst1Overlay = function() {
    //alert("openInst1Overlay");
    emptyLightUp();
    var overlay = $("#overlay");
    var contentHolder =  $("#overlayLightUpHolder");
    overlay.css("display", "block");
    contentHolder.css("display", "block");
}

Site.closeInst1Overlay = function() {
    //alert("closeInst1Overlay");
    embedLightUp();
    $("#overlay").css("display", "none");
    $("#overlayLightUpHolder").css("display", "none");
}

Site.openInst2Overlay = function() {
    //alert("openInst2Overlay");
    emptyVariationBW();
    var overlay = $("#overlay");
    var contentHolder =  $("#overlayVariationBWHolder");
    overlay.css("display", "block");
    contentHolder.css("display", "block");
    $('#mcontent2').css("border", "none");
}

Site.closeInst2Overlay = function() {
    //alert("closeInst2Overlay");
    $('#mcontent2').css("border", "1px solid black");
    $("#overlay").css("display", "none");
    $("#overlayVariationBWHolder").css("display", "none");
    embedVariationBW();
}
...
Site.main = function() {
        ...
        if (rel != "index") {
	       ...
	       /**/
		    ...
		    if (isSub == "true") { //MULTIMEDIA or WEBMEDIA (subMenu)
                ...
                /*if (section == "#webmedia") {
                    console.log('INFO scrollPage :: Webmedia!!');
                } else {
                    console.log('INFO scrollPage :: Multimedia!!');
                } */
	        ...
	        } //else { //INFO  (menu w/o subMenu)
                //console.log('INFO scrollPage :: INFO?');
            //}
        } else {
            console.log('INFO site.js.js :: scrollPage - HOME-logo!!');
        	//-- if home (logo click)
        	//homePlay();	//TODO
        }
    ...
    /*var manifest = [
                    "assets/image/webmedia/img0_05_0_BMG_529x484.jpg",
                    "assets/image/webmedia/img1_05_1_FirstCom_529x484.jpg",
                    "assets/image/webmedia/img2_05_2_KillerTracks_529x484.jpg",
                    "assets/image/webmedia/img3_05_3_WellTV_529x484.jpg",
                    "assets/image/webmedia/img4_06_0_Premarin_529x484.jpg",
                    "assets/image/webmedia/img5_06_1_Malibu_529x484.jpg",
                    "assets/image/webmedia/img6_06_2_ATT_529x484.jpg",
                    "assets/image/webmedia/img7_06_3_Borders_529x484.jpg",
                    "assets/image/webmedia/img8_07_0_FBSnowball_529x484.jpg",
                    "assets/image/webmedia/img9_07_1_JCP_529x484.jpg",
                    "assets/image/webmedia/img10_07_2_Citi_529x484.jpg",
                    "assets/image/webmedia/img11_07_3_TAG_529x484.jpg",
                    "assets/image/webmedia/img12_08_0_MaxwellHouse_529x484.jpg",
                    "assets/image/webmedia/img13_08_0_Slimfast_529x484.jpg",
                    "assets/image/webmedia/img14_08_1_Dove_529x484.jpg",
                    "assets/image/webmedia/img15_08_2_Enfamil_529x484.jpg",
                    "assets/image/webmedia/img16_08_3_IBM_529x484.jpg",
                    "assets/image/webmedia/img17_08_4_SlimFast_529x484.jpg",
                    "assets/image/webmedia/img18_09_SXR_529x484.jpg",
                    "assets/image/webmedia/img19_09_0_HBO_529x484.jpg",
                    "assets/image/webmedia/img20_09_1_SAP_529x484.jpg",
                    "assets/image/webmedia/img21_09_3_FMG_529x484.jpg",
                    "assets/image/webmedia/img22_09_4_IBMTivoli_529x484.jpg",
                    "assets/image/webmedia/img23_09_5_HolidayCard_529x484.jpg",
                    "assets/image/webmedia/img24_09_2_MH_529x484.jpg",
                    "assets/image/webmedia/img25_10_0_SaraLee_529x484.jpg",
                    "assets/image/webmedia/img26_10_1_SAPCareer_529x484.jpg",
                    "assets/image/webmedia/img27_10_6_TWC_529x484.jpg",
                    "assets/image/webmedia/img28_10_2_OgilvyYoutube_529x484.jpg",
                    "assets/image/webmedia/img29_10_4_Nestle_529x484.jpg",
                    "assets/image/webmedia/img30_10_5_SAP_529x484.jpg",
                    "assets/image/webmedia/img31_10_3_Factoids_529x484.jpg",
                    "assets/image/webmedia/img32_11_0_JED_529x484.jpg",
                    "assets/image/webmedia/img33_11_1_GE_529x484.jpg",
                    "assets/image/webmedia/img34_11_2_IBM_529x484.jpg",
                    "assets/image/webmedia/img35_12_0_OSIAO_529x484.jpg",
                    "assets/image/webmedia/img36_12_1_Subtexter_529x484.jpg",
                    "assets/image/webmedia/img37_13_0_FMG_529x484.jpg",
                    "assets/image/webmedia/img38_14_Zoetis_529x484.jpg",
                    "assets/image/webmedia/img39_14_Xerox_529x484.jpg"
    ];*/
    var manifest = [
...
        preload.loadFile(item);
    ...
    function handleFileLoad(event) {
        //console.log("INFO site.js :: handleFileLoad EVER??, event.item.id is " + event.item.id);
        ...
        if (preload.progress == 1) {
            ...
            var parent = $("#slides");
            parent.append('<div class="slidesjs-container"></div>');
            $(".slidesjs-container").append('<div class="slidesjs-control"></div>');
            map.sort(sortImages);
            for(var i= 0;i<map.length;i++){
                var item = $(map[i].data);
                item.addClass('slidesjs-slide');
                item.attr('id','img'+i);                     
                $(".slidesjs-control").append(item);
            }
